    ...
    <div class="well well-custom">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <div class="well">
            <h3 class="text-center bg-primary" style="padding: 7px;">Edit Intern</h3><br>


            <div class="row">
              <div class="col-md-7">
                <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="file" name="profileimg" class="form-control input-custom" required>
